      ...
      <div className="row fill">
        <div className="col-sm-3 fill">
          ...
          <div className="panel panel-default fill">
            <div className="panel-heading" data-toggle="tooltip" style={{ padding: '0px' }}>
              <span id="refreshSourceHubs" className="glyphicon glyphicon-refresh" style={{ cursor: 'pointer', display: 'none' }} title="Refresh list of files" />
            </div>
            <div id="sourceHubs">
              ...
              <form className="bs-example bs-example-form" role="form">
                  ...
                  <div style={{ paddingTop: '10px', textAlign: 'left' }}>
                    <div className="col-lg-12">
                      ...
                      <div className="input-group">
                        ...
                        <label className="form-control">Import parameters from Excel</label>
                      </div>
                      <div className="form-group" id="importFile" style={{ display: 'none' }}>
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <button type="button" className="btn btn-primary" id="exportImportButton">Export / Import</button>
                  </div>
                </div>
              </form>
            </div>
