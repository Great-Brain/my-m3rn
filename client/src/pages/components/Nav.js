  ...
  return (
    <nav className="navbar navbar-default navbar-fixed-top">
      <div className="container-fluid">
        ...
        <ul className="nav navbar-nav right col-lg-2">
          <li>
            <div style={{ float: 'right', marginTop: '15px', cursor: 'pointer' }}>
              <span style={{ paddingRight: '5px' }} data-toggle="modal" data-target="#defineActivityModal" title="Configura AppBundle & Activity">
        ...
        <ul className="nav navbar-nav right col-lg-2">
          <div style={{ paddingTop: '10px', textAlign: 'right' }}>
            <li>
              <button className="btn btn-sm btn-default" id="autodeskSigninButton" hidden>
                Sign In &nbsp;&nbsp;
                <img src="https://cdn.autodesk.io/autodesk.png" height="20" />
              </button>
              <button className="btn btn-sm btn-default" id="autodeskSignOutButton" hidden>
                Sign Out &nbsp;&nbsp;<span id="userInfo" />
              </button>
            </li>
          </div>
        </ul>
