...
CustomPropertyPanel.prototype = Object.create(
...
CustomPropertyPanel.prototype.setProperties = function (properties, options) {
  ...
  this.viewer.getProperties(this.nodeId, function (props) {
    props.properties.forEach((prop) => {
      if (prop.displayName === "Fire Rating" || prop.displayName === "Comments")
        that.addProperty(
          prop.displayName,
          prop.displayValue,
...
CustomPropertyPanelExtension.prototype = Object.create(
  Autodesk.Viewing.Extension.prototype
);
CustomPropertyPanelExtension.prototype.constructor =
...
CustomPropertyPanelExtension.prototype.createToggler = function (
  button,
  click,
  unclick
) {
